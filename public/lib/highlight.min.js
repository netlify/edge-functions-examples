// Supported languages in this file
...
"object" == typeof exports &&
  ...
  (module.exports = hljs); /*! `typescript` grammar compiled for Highlight.js 11.5.0 */
(() => {
  var e = (() => {
    "use strict";
    ...
    function o(o) {
      const l = o.regex,
        ...
        A = {
          ...
          starts: { end: "`", returnEnd: !1, contains: [o.BACKSLASH_ESCAPE, y], subLanguage: "xml" },
        },
        _ = {
          begin: "css`",
          end: "",
          starts: { end: "`", returnEnd: !1, contains: [o.BACKSLASH_ESCAPE, y], subLanguage: "css" },
        },
        p = { className: "string", begin: "`", end: "`", contains: [o.BACKSLASH_ESCAPE, y] },
        N = {
          className: "comment",
          variants: [
            o.COMMENT(/\/\*\*(?!\/)/, "\\*/", {
      ...
      const h = [].concat(N, y.contains),
        ...
        S = { className: "params", begin: /\(/, end: /\)/, excludeBegin: !0, excludeEnd: !0, keywords: g, contains: v },
        w = {
          variants: [
            {
                ...
                contains: [
                  {
                    ...
                    variants: [
                      ...
                      { begin: /\(/, end: /\)/, excludeBegin: !0, excludeEnd: !0, keywords: g, contains: v },
                    ],
                  },
                ],
              },
        ...
        contains: [
          {
            ...
            contains: [
              ...
              i,
              {
                ...
                contains: [{ className: "meta", begin: /<![a-z]/, end: />/, contains: [t, i, l, c] }],
              },
            ],
          },
          e.COMMENT(/<!--/, /-->/, {
