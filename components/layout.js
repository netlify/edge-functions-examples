...
<html lang="en">
  ...
  <main class="main">
    ...
    <section>
      ...
      <p>To use Edge Functions on Netlify, add JavaScript or Typescript files to an edge-functions directory in your project. <a href="https://docs.netlify.com/edge-functions/configure-and-build/" target="_blank">Learn more on the docs</a>.</p>
